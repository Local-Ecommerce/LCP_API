namespace DAL.Constants
{
    ...
    public enum ProductStatus
    {
        ...
        REJECTED_PRODUCT = 1006,
        UNVERIFIED_CREATE_PRODUCT = 1007,
        UNVERIFIED_UPDATE_PRODUCT = 1008
    }
    ...
    public enum MerchantStatus
    {
        ...
        REJECTED_MERCHANT = 2006,
        UNVERIFIED_CREATE_MERCHANT = 2007,
        UNVERIFIED_UPDATE_MERCHANT = 2008,
        INVALID_NAME_MERCHANT = 2009 ,
        INVALID_PHONE_NUMBER_MERCHANT = 2010,
    }
    ...
    public enum ProductCategoryStatus
    {
        ...
        REJECTED_PRODUCT_CATEGORY = 5006,
        UNVERIFIED_CREATE_PRODUCT_CATEGORY = 5007,
        UNVERIFIED_UPDATE_PRODUCT_CATEGORY = 5008,
    }
    ...
    public enum MerchantStoreStatus
    {
        ...
        REJECTED_MERCHANT_STORE = 6006,
        UNVERIFIED_CREATE_MERCHANT_STORE = 6007,
        UNVERIFIED_UPDATE_MERCHANT_STORE = 6008,
    }
